...
# CONT: Yazen Alzaghameem                               #
# DATE: 26 May 2016                                     #
# INFO: deals with individual card attributes           #
# ----------------------------------------------------- #
...
class Card
  ...
  # add single card to the end of cards_on_table array (cards currently in play on the table)
  ...
  def deal_card(cards_on_table)
    ...
    self.print_card                               # TODO: print card attributes to console; can be removed as needed
  end

  # outputs card attributes to console
  def print_card
    # TODO: function currently commented out; method may be removed
